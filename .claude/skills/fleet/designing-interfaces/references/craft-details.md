...
- [Focus states and forms](#1-focus-states)
- [Images and touch](#3-images)
- [Performance and accessibility](#5-performance-patterns)
- [Navigation and copy](#7-navigation--state)
- [Anti-patterns and pre-ship checklist](#9-anti-patterns-checklist)

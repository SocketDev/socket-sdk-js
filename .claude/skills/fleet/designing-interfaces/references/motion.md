...
- [Motion pyramid, timing, and easing](#1-the-motion-pyramid)
- [Micro-interactions and tokens](#4-micro-interactions-that-work)
- [Reduced motion](#6-reduced-motion-not-optional)

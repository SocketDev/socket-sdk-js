...
When a finding lands, the next question is always: **does this same shape exist anywhere else in the repo?** Variant analysis is the systematic answer. Note: a finding can be a bug, a regression, or a security issue.

# Patching Findings Procedure

## Contents

- [Worktree safety](#worktree-safety-read-before-applying-anything)
- [Checkpointing](#checkpointing)
- [Parse and normalize](#phase-0-parse-arguments)
- [Generate candidate patches](#phase-2-generate-patches)
- [Independent blind review](#phase-3-independent-blind-review-the-gate)
- [Apply, commit, and report](#phase-4-apply-and-commit-the-fleet-divergence-from-upstream)
- [Guardrails, testing, and provenance](#guard-rails)

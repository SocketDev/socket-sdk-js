# follow-direct-imperative-nudge
...
- `dont-stop-mid-queue-nudge`: Stop hook for premature "what's next?" after authorized continuous-work directives.
- `ask-suppression-nudge`: Stop hook for AskUserQuestion when recent transcript already authorized the obvious default.

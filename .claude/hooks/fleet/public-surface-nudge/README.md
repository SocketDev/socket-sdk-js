    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .claude/hooks/fleet/public-surface-nudge/index.mts"
          }
        ]
      }
    ]
...
- [`private-name-nudge`](../private-name-nudge/) — primes on private
  repo / project names.
...
[`socket-wheelhouse`](https://github.com/SocketDev/socket-wheelhouse/tree/main/template/.claude/hooks/public-surface-nudge)

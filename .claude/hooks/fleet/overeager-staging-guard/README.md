...
- `Allow git commit-all bypass` (verbatim, recent user turn) - lets a bare commit take the whole git index / staging area (Layer 2), for when you genuinely mean to commit everything staged.

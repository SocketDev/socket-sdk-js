#!/usr/bin/env node
// Claude Code PreToolUse hook — claude-md-prefer-external-detail-reminder.
//
...
//
// Disable via SOCKET_CLAUDE_MD_PREFER_EXTERNAL_DETAIL_DISABLED.
...
async function main(): Promise<void> {
  ...
  if (process.env['SOCKET_CLAUDE_MD_PREFER_EXTERNAL_DETAIL_DISABLED']) {
    return
  }

# programmatic-claude-lockdown-guard
...
`.claude/skills/fleet/locking-down-programmatic-claude/SKILL.md`): a headless
...
- Type `Allow programmatic-claude-lockdown bypass` in a recent message, or set
  `SOCKET_PROGRAMMATIC_CLAUDE_LOCKDOWN_GUARD_DISABLED=1`.

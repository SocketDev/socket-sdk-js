#!/usr/bin/env node
// Claude Code PreToolUse hook — programmatic-claude-lockdown-guard.
//
...
// .claude/skills/fleet/locking-down-programmatic-claude/SKILL.md):
...
// turn, or SOCKET_PROGRAMMATIC_CLAUDE_LOCKDOWN_GUARD_DISABLED=1.
...
await withBashGuard((command, payload) => {
  if (isHookDisabled('programmatic-claude-lockdown-guard')) {
    return
  }
  ...
  logger.error(
    [
      `[programmatic-claude-lockdown-guard] Blocked: ${reason}.`,
      '',

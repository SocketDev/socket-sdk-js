...
This is the close sibling of [`public-surface-nudge`](../public-surface-nudge/),
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .claude/hooks/fleet/private-name-nudge/index.mts"
          }
        ]
      }
    ]
...
[`socket-wheelhouse`](https://github.com/SocketDev/socket-wheelhouse/tree/main/template/.claude/hooks/private-name-nudge)

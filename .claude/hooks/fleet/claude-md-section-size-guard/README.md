...
Sections that exceed 8 lines should have a long-form companion at `docs/agents.md/fleet/<topic>.md` and the inline body should shrink to 1-2 sentences plus a link. The cap was 20 initially (during the bootstrap when several fleet sections were 12-19 lines); it tightened to 8 once those sections were outsourced.
...
- How many lines over.
- The canonical fix: move the long form to `docs/agents.md/fleet/<topic>.md` and leave a 1-sentence summary + link.

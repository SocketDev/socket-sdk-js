#!/usr/bin/env node
// Claude Code Stop hook — answer-passing-questions-reminder.
//
...
//
// Disable via SOCKET_ANSWER_PASSING_QUESTIONS_REMINDER_DISABLED.
...
async function main(): Promise<void> {
  if (process.env['SOCKET_ANSWER_PASSING_QUESTIONS_REMINDER_DISABLED']) {
    return
  }

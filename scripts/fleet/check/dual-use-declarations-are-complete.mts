...
const SCRIPT_META: ScriptMeta = {
  describe:
    'checks npm dual-use declarations are complete for every declared package root',
  help: 'Usage: node scripts/fleet/check/dual-use-declarations-are-complete.mts',
}

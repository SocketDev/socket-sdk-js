...
const SCRIPT_META: ScriptMeta = {
  describe:
    'verifies lint config verbatim-file exclusions cannot be overridden by a later re-include',
  help: `Usage: node scripts/fleet/check/lint-configs-protect-verbatim.mts [flags]

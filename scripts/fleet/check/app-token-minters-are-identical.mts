 ...
 *   logic while the others moved on.
 *
 *   Scans the live `.github/actions/**` and the cascaded source under
 *   `template/base/.github/actions/**` + `template/overrides/socket-registry/.github/actions/**`.
 *   Exit 0 = 0/1 copies, or all identical. Exit 1 = drift, listed with What /
 *   Where / Saw-vs-wanted / Fix. CI gate via `scripts/check.mts`.
 *   Usage: node scripts/fleet/check/app-token-minters-are-identical.mts.
 */
...
// socket-registry override (which hosts the shared release-/pr-app-token).

...
const SCRIPT_META: ScriptMeta = {
  describe:
    'checks every workflow running native tests gates the run through the run-offline action',
  help: `Usage: node scripts/fleet/check/native-tests-are-network-off.mts [flags]

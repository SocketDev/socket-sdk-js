...
const SCRIPT_META: ScriptMeta = {
  describe:
    'checks every upstream/ reference submodule declares shallow = true and a branch pin',
  help: `Usage: node scripts/fleet/check/upstream-submodules-are-shallow-single-branch.mts [flags]

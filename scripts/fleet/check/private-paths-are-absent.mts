...
import { splitLines, walkComments } from '../../../.claude/hooks/fleet/_shared/acorn/index.mts'
import {
 ...
 * `isPurePlaceholder` (a bracketed user token, a `$VAR`, or a CI service-account
 * home) — the same posture the fleet's personal-path scanner already takes.
 */

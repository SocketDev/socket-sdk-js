...
const SCRIPT_META: ScriptMeta = {
  describe:
    'checks that no distributed build config pins a microarch above the supported minimum',
  help: `Usage: node scripts/fleet/check/build-microarch-is-portable.mts [--quiet]

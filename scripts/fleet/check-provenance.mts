 ...
 *   trustedPublisher status, attestation URL. Usage: pnpm exec node
 *   scripts/fleet/check-provenance.mts <name>
 *
 *   # last 10 versions
 *
 *   pnpm exec node scripts/fleet/check-provenance.mts <name> --all.
 *
 *   # every published version
 *
 *   pnpm exec node scripts/fleet/check-provenance.mts <name> --version 1.2.3.
 *
 *   # one specific version
 *
 *   pnpm exec node scripts/fleet/check-provenance.mts <name> --json.
 *
 *   # pipe to jq / scripts
 *

...
// ---------------------------------------------------------------------------
// Top-level functions: private helpers, dispatcher, kind checkers,
// summary builders, and the main() entrypoint. Sorted alphanumerically
// per the fleet `socket/sort-source-methods` rule, so a reader can
// predict where any function lives.
// ---------------------------------------------------------------------------

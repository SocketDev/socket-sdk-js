...
export interface paths {
  ...
  "/orgs/{org_slug}/alerts/resolutions/{uuid}": {
     ...
     * @description Fetch a single active alert resolution by UUID. Returns the same row shape as the list endpoint. Tokens restricted to specific repositories cannot read resolutions anchored to repositories outside their grants.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Delete an alert resolution by UUID. Once deleted, alerts previously hidden by this resolution will reappear after the next org snapshot. Tokens restricted to specific repositories may only delete resolutions anchored to a granted repository.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
  ...
  "/orgs/{org_slug}/alert-policies": {
     ...
     * @description List the alert policies of an organization. The default policy (which applies to all repositories without a policy label) is always first, followed by custom policies ordered by creation time. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Create an alert policy. A repo label with the same name is created to scope the policy; repositories carrying that label are governed by the policy. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
  ...
  "/orgs/{org_slug}/alert-policies/{policy_id}": {
     ...
     * @description Fetch a single alert policy by ID. Use `default` as the ID for the default policy, which applies to all repositories without a policy label. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Update an alert policy. Only the provided fields change; `repository_ids` replaces the full set of repositories the policy scopes to. The default policy cannot be renamed and its scope is implicit. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Delete an alert policy along with its rules and repo label. Repositories previously scoped to the policy fall back to the default policy after the next org snapshot. The default policy cannot be deleted. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
  ...
  "/orgs/{org_slug}/alert-policies/{policy_id}/rules": {
     ...
     * @description List the custom rules of an alert policy in evaluation order (ascending rank). Rules are evaluated before the policy baseline; the first matching rule decides the alert action. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
  ...
  "/orgs/{org_slug}/alert-policies/{policy_id}/rules/{rule_id}": {
     ...
     * @description Fetch a single alert policy rule by UUID. Returns the same row shape as the rules list endpoint. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Update an alert policy rule. Only the provided fields change. To move the rule, provide at most one of `position`, `rank`, `before_rule_id`, or `after_rule_id`. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
     ...
     * @description Delete an alert policy rule. Alerts previously matched by this rule are re-evaluated against the remaining rules and baseline after the next org snapshot. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
  ...
  "/orgs/{org_slug}/alert-policies/migration/status": {
     ...
     * @description Retrieve the alert policy migration status of an organization. This is read-only and does not enroll organizations or start migration windows. Requires a token with org-wide repository access; repo-restricted tokens receive 403.
     *
     * This endpoint consumes 1 unit of your quota.
     *
     * This endpoint requires the following org token scopes:
...
export interface components {
  schemas: {
    ...
    SocketArtifact: components["schemas"]["SocketPURL"] & components["schemas"]["SocketArtifactLink"] & {
      ...
      /**
       * @description ISO-8601 timestamp of when this package version or artifact was published, when known. Currently populated for PURL types: actions, cargo, composer, go, maven, npm, nuget, openvsx, pypi, and rubygems. Maven and PyPI can use artifact-grain dates when artifact qualifiers identify a concrete artifact; other listed ecosystems use package-version dates.
       * @default
       */
      publishedAt?: string;
    ...
    PurlErrorSchema: {
      ...
      /** @default */
      inputPurl: string;
      /** @description True when the error is transient (timeout or shed resolution) and a retry can succeed. Absent or false means the error is an authoritative verdict for this input. */
      retryable: boolean;
    };
    PurlSummarySchema: {
      /** @default 0 */
    ...
    SocketAlert: {
      ...
      /**
       * @description Additional alert-specific properties and metadata that vary by alert type. For vulnerability alerts this includes the `cveId` and `ghsaId` identifiers, either of which may be an empty string when GitHub has not assigned that identifier to the advisory.
       * @default null
       */
      ...
      actionSource?: {
        ...
        candidates: Array<({
            ...
            repoLabelId: string;
            /**
             * @description ID of the alert policy whose rule matched. Absent when not applicable (alert-policy candidates only)
             * @default
             */
            policyId?: string;
            /**
             * @description Display name of the matched alert policy at evaluation time; null for the default policy. Absent when not applicable (alert-policy candidates only)
             * @default
             */
            policyName?: string | null;
            /**
             * @description ID of the matched alert policy rule: the rule uuid for custom rules, the issue name for baseline rules. Absent when not applicable (alert-policy candidates only)
             * @default
             */
            ruleId?: string;
            /**
             * @description Name of the matched alert policy rule at evaluation time. Absent when not applicable (alert-policy candidates only)
             * @default
             */
            ruleName?: string;
            /**
             * @description 0-based position of the matched rule in first-match-wins evaluation order. Absent when not applicable (alert-policy candidates only)
             * @default 0
             */
            ruleIndex?: number;
            /**
             * @description Whether the matched alert policy rule is a baseline rule. Absent when not applicable (alert-policy candidates only)
             * @default false
             */
            isBaseline?: boolean;
          })>;
    ...
    SocketIssue: ({
      ...
      value?: components["schemas"]["SocketIssueBasics"] & {
        ...
        props: {
          ...
          checkedAt: string;
          /**
           * @description Org-configured recently published threshold in days.
           * @default 0
           */
     ...
     * @enum {string}
     */
    SocketPURL_Type: "alpm" | "apk" | "bitbucket" | "cocoapods" | "cargo" | "chrome" | "clawhub" | "composer" | "conan" | "conda" | "cran" | "deb" | "docker" | "firefox-extension" | "edge-extension" | "gem" | "generic" | "github" | "golang" | "hackage" | "hex" | "huggingface" | "maven" | "mlflow" | "npm" | "nuget" | "qpkg" | "oci" | "pub" | "pypi" | "rpm" | "socket" | "swid" | "swift" | "vscode" | "vscode-extension" | "unknown";
    /**
     * @default low
     * @enum {string}
     */
    ...
    /** @description The alert policy rule that decided `action`. Included in both normal and `compact=true` responses whenever an alert policy rule decided the action; absent when the action came from any other source. Unrelated to `actionPolicyIndex`, which indexes the legacy security policy */
    SocketAlertPolicyRule: {
      /**
       * @description ID of the alert policy whose rule decided this action: a UUID, or `default` for the default policy until it is first customized
       * @default
       */
      policyId: string;
      /**
       * @description Display name of that policy at evaluation time; null for the default policy
       * @default
       */
      policyName: string | null;
      /**
       * @description ID of the rule that decided this action: the rule UUID for custom rules, the alert type name for baseline rules
       * @default
       */
      ruleId: string;
      /**
       * @description Name of that rule at evaluation time; baseline rules use the alert type name
       * @default
       */
      ruleName: string;
      /**
       * @description 0-based position of the rule in first-match-wins evaluation order (custom rules first, then baseline)
       * @default 0
       */
      ruleIndex: number;
      /**
       * @description Whether the rule is a baseline rule rather than a custom rule
       * @default false
       */
      isBaseline: boolean;
    };
    ...
    ReachabilityResultItem: {
      ...
      /**
       * @description For direct_dependency results: the direct importer is a private/unresolvable package in the project rather than the application manifest
       * @default false
       */
     ...
     * @enum {string}
     */
    ReachabilityType: "missing_support" | "undeterminable_reachability" | "pending" | "unreachable" | "unknown" | "direct_dependency" | "error" | "maybe_reachable" | "reachable";
    CallStackItem: {
      /**
      ...
      content: {
        "application/json": {
          error: {
            ...
            details: {
              /**
               * @description Per-request id; also the X-Request-Id header
               * @default
               */
              requestId: string;
              /**
               * @description Coarse failure class
               * @default internal
               * @enum {string}
               */
...
export interface operations {
  ...
  GetOrgDiffScan: {
    ...
    responses: {
      ...
      /** @description Scan is being processed. Repeat the request later to retrieve results. */
      202: {
        content: {
          "application/json": {
            /** @default processing */
      ...
      201: {
        content: {
          "application/json": {
            ...
            status: string;
            /**
             * @description The rescan mode actually performed. A "shallow" request falls back to "deep" when the source scan has no cached data.
             * @default shallow
             * @enum {string}
             */
            mode: "shallow" | "deep";
  ...
  getDiffScanById: {
    parameters: {
      query?: {
        ...
        /** @description Omit unchanged artifacts from the response. When set to true, the unchanged field will be set to null. */
        omit_unchanged?: boolean;
        /** @description Enable polling mode for immutable diff scan results. When results are cached, returns the pre-computed scan. When results are not yet cached, returns 202 Accepted and enqueues a background job. Note: When cached=true, the omit_license_details parameter is ignored as cached results always include license details. */
        cached?: boolean;
      };
      path: {
        /** @description The slug of the organization */
        ...
        content: {
          "application/json": {
            diff_scan: {
              ...
              api_url: string | null;
              /**
               * @description True when either side of the diff was truncated at the plan's dependency limit. When set, the gfm comments contain a limit-exceeded notice instead of a report rendered from the imbalanced diff.
               * @default false
               */
              incomplete: boolean;
              /** @description Pull request comments rendered in GitHub flavored markdown. */
              gfm: {
                /**
                 * @description Dependency overview comment in GitHub flavored markdown. Empty when there is nothing to show; consumers should not post a comment in that case.
                 * @default
                 */
                overview: string;
                /**
                 * @description Dependency alert comment in GitHub flavored markdown. Contains a dependency-limit-exceeded notice instead of a report when incomplete is true.
                 * @default
                 */
                alerts: string;
              };
  ...
  createOrgDiffScanFromIds: {
    parameters: {
      query: {
        ...
        /** @description Set to true when running a diff between a merged commit and its parent commit in the same branch. Set to false when running diffs in an open PR between unmerged commits. */
        merge?: boolean;
        /** @description Set to "redirect" to receive a 302 redirect to the existing diff scan instead of a 409 error when a duplicate is detected. Set to "update" to apply the supplied external_href to the existing diff scan and receive it in a 200 response; when external_href is omitted, the existing value is left untouched. */
        on_duplicate?: string;
      };
      path: {
        /** @description The slug of the organization */
    ...
    responses: {
      /** @description The existing diff scan when on_duplicate=update is set and a duplicate is detected. If external_href was supplied, it has been applied to the diff scan. */
      200: {
        content: {
          "application/json": {
            diff_scan: {
      ...
      /** @description Redirects to the existing diff scan when on_duplicate=redirect is set and a duplicate is detected. */
      302: {
        content: {
          "application/json": {
            diff_scan: {
        ...
        content: {
          "application/json": {
            items: Array<({
                ...
                comment: string | null;
                /**
                 * @description The full selector describing which alerts the resolution applies to. The anchor fields below are a derived summary — compound selectors (e.g. `$or` over several repos) cannot be summarized and read back as null anchors, so this is the source of truth.
                 * @default null
                 */
                vigil_selector: Record<string, never>;
                /**
  ...
  createOrgAlertResolution: {
    parameters: {
      query?: {
        /** @description Rehearse the write: authorize and validate the request and return the response body a real write would produce, then discard it. Accepts `true`, `1`, or `yes`. Other present values return 400 so a typo cannot persist. Nothing is persisted. A dry-run success is HTTP 200 with `dry_run: true`, not 201. */
        dry_run?: boolean;
      };
      path: {
        /** @description The slug of the organization */
    ...
    requestBody: {
      content: {
        "application/json": {
          /**
           * @description The reason the alert is resolved. One of: false_positive, remediated, tolerable_risk, other.
           * @enum {string}
           */
          reason: "false_positive" | "remediated" | "tolerable_risk" | "other";
          /**
           * @description Selector describing which alerts the resolution applies to. Fields must all be under finding.*, location.*, or artifact.* (e.g. `{"finding.alertType": "criticalCVE", "artifact.name": "lodash"}`).
           * @default null
           */
          vigil_selector: Record<string, never>;
          /**
           * @description Free-form reason text, mainly for when `reason` is `other` (1-256 characters).
           * @default
           */
          reason_text?: string | null;
          /**
           * @description Operator-provided comment (1-1024 characters).
           * @default
           */
          comment?: string | null;
        };
    ...
    responses: {
      /** @description Dry-run: the write was not persisted. */
      200: {
        content: {
          "application/json": {
            /**
            ...
            updated_at: string;
            /**
             * @description True when `?dry_run=true` (or `1` / `yes`) rehearsed the write; nothing was persisted.
             * @default false
             */
            dry_run?: boolean;
          };
      ...
      /** @description The created alert resolution. */
      201: {
        content: {
          "application/json": {
            /**
  ...
  getOrgAlertPolicies: {
    ...
    responses: {
      /** @description Lists alert policies for the specified organization. */
      200: {
        content: {
          "application/json": {
            items: Array<({
                /**
                 * @description The ID of the policy: a UUID, or `default` for the default policy until it is first customized.
                 * @default
                 */
                id: string;
                /**
                 * @description The policy name. Null for the default policy, which applies to all repositories without a policy label.
                 * @default
                 */
                name: string | null;
                /**
                ...
                description: string | null;
                /**
                 * @description How the policy scopes to repositories: `labeled_repos` applies to repositories carrying the policy repo label; `unlabeled_repos` is the default policy for all unlabeled repositories.
                 * @default labeled_repos
                 * @enum {string}
                 */
                apply_method: "labeled_repos" | "unlabeled_repos";
                /**
                 * @description The repo label that scopes this policy. Null for the default policy.
                 * @default
                 */
                repo_label_id: string | null;
                /** @description Repositories the policy scopes to. Empty for the default policy and for policies with no repository assignments. */
                repository_ids: string[];
                /**
                 * @description Baseline rule bundle the policy starts from. One of: essential, balanced, comprehensive. Null when the policy has no baseline.
                 * @default
                 */
                baseline: string | null;
                /**
                 * @description User ID that created the policy.
                 * @default
                 */
                created_by: string | null;
                /**
                 * @description User ID that last updated the policy.
                 * @default
                 */
                updated_by: string | null;
                /**
                 * @description ISO-8601 creation timestamp. Null for the default policy until it is first customized.
                 * @default
                 */
                created_at: string | null;
                /**
                 * @description ISO-8601 last-update timestamp. Null for the default policy until it is first customized.
                 * @default
                 */
  ...
  createOrgAlertPolicy: {
    ...
    requestBody: {
      content: {
        "application/json": {
          /** @description The policy name (1-120 characters). Also used as the name of the repo label that scopes the policy. */
          name: string;
          /**
           * @description Operator-provided description (up to 256 characters).
           * @default
           */
          description?: string | null;
          /** @description Repositories to scope the policy to. */
          repository_ids?: string[] | null;
          /**
           * @description Baseline rule bundle the policy starts from. One of: essential, balanced, comprehensive. Null for no baseline.
           * @default
           */
          baseline?: string | null;
        };
  ...
  getOrgAlertPolicy: {
    parameters: {
      path: {
        /** @description The slug of the organization */
        org_slug: string;
        /** @description The ID of the alert policy: a UUID, or `default` for the default policy */
        policy_id: string;
      };
    };
    responses: {
      /** @description The requested alert policy. */
      200: {
        content: {
          "application/json": {
            /**
  ...
  updateOrgAlertPolicy: {
    ...
    requestBody: {
      content: {
        "application/json": {
          /**
           * @description The policy name (1-120 characters). The default policy cannot be renamed.
           * @default
           */
          name?: string;
          /**
           ...
           */
          description?: string | null;
          /** @description Full replacement set of repositories the policy scopes to. The default policy scope is implicit and cannot be set. */
          repository_ids?: string[] | null;
          /**
           * @description Baseline rule bundle the policy starts from. One of: essential, balanced, comprehensive. Null to remove the baseline.
           * @default
           */
          baseline?: string | null;
        };
    ...
    responses: {
      /** @description The updated alert policy. Dry-run responses include `dry_run: true` and were not persisted. */
      200: {
        content: {
          "application/json": {
            /**
  ...
  deleteOrgAlertPolicy: {
    parameters: {
      ...
      path: {
        /** @description The slug of the organization */
        org_slug: string;
        /** @description The UUID of the alert policy to delete */
        policy_id: string;
      };
    };
    responses: {
      /** @description Deleted the alert policy, or rehearsed the delete when `dry_run` is true. */
      200: {
        content: {
          "application/json": {
            /**
             * @description Present on a persisted delete.
             * @default
             */
            result?: string;
            /**
  ...
  getOrgAlertPolicyRules: {
    ...
    responses: {
      /** @description Lists the rules of the specified alert policy. */
      200: {
        content: {
          "application/json": {
            items: Array<({
                ...
                id: string;
                /**
                 * @description The UUID of the policy the rule belongs to.
                 * @default
                 */
                alert_policy_id: string;
                /**
                 * @description Fractional-index rank; rules are evaluated in ascending rank order.
                 * @default
                 */
                rank: string;
                /**
                ...
                name: string;
                /**
                 * @description Selector describing which alerts the rule applies to. Fields must all be under finding.*, location.*, or artifact.* (e.g. `{"finding.alertType": "criticalCVE", "artifact.name": "lodash"}`).
                 * @default null
                 */
                vigil_selector: Record<string, never>;
                /**
                 * @description The action applied to matching alerts. One of: error, warn, monitor, ignore.
                 * @default monitor
                 * @enum {string}
                 */
                action: "error" | "warn" | "monitor" | "ignore";
                /**
                 * @description Operator-provided note.
                 * @default
                 */
                note: string | null;
                /**
                ...
                created_by: string | null;
                /**
                 * @description User ID that last updated the rule.
                 * @default
                 */
                updated_by: string | null;
                /**
  ...
  createOrgAlertPolicyRule: {
    ...
    requestBody: {
      content: {
        "application/json": {
          /** @description The rule name (1-128 characters). */
          name: string;
          /**
           * @description Selector describing which alerts the rule applies to. Fields must all be under finding.*, location.*, or artifact.* (e.g. `{"finding.alertType": "criticalCVE", "artifact.name": "lodash"}`).
           * @default null
          ...
          action: string;
          /**
           * @description Operator-provided note (up to 256 characters).
           * @default
           */
          note?: string | null;
          /**
           * @description Where to place the rule within the policy: `first` or `last`. Mutually exclusive with `rank`, `before_rule_id`, and `after_rule_id`; when no position is provided a created rule is placed first.
           * @default
           */
          position?: string;
          /**
           * @description Explicit rank, as a `fractional-indexing` base62 order key (e.g. `a0`, `a0V`). Prefer `position`, `before_rule_id`, or `after_rule_id`; a rank that is not a valid order key is rejected.
           * @default
           */
          rank?: string;
          /**
           * @description Place the rule immediately before this rule UUID.
           * @default
           */
          before_rule_id?: string | null;
          /**
           * @description Place the rule immediately after this rule UUID.
           * @default
           */
    ...
    responses: {
      ...
      /** @description The created alert policy rule. */
      201: {
        content: {
          "application/json": {
            /**
  ...
  getOrgAlertPolicyRule: {
    parameters: {
      path: {
        ...
        /** @description The ID of the alert policy: a UUID, or `default` for the default policy */
        policy_id: string;
        /** @description The UUID of the rule to fetch */
        rule_id: string;
      };
    };
    responses: {
      /** @description The requested alert policy rule. */
      200: {
        content: {
          "application/json": {
            /**
  ...
  updateOrgAlertPolicyRule: {
    ...
    requestBody: {
      content: {
        "application/json": {
          ...
          rank?: string;
          /**
           * @description Move the rule immediately before this rule UUID.
           * @default
           */
          before_rule_id?: string | null;
          /**
           * @description Move the rule immediately after this rule UUID.
           * @default
           */
          after_rule_id?: string | null;
        };
    ...
    responses: {
      /** @description The updated alert policy rule. Dry-run responses include `dry_run: true` and were not persisted. */
      200: {
        content: {
          "application/json": {
            /**
  ...
  deleteOrgAlertPolicyRule: {
    ...
    responses: {
      /** @description Deleted the alert policy rule, or rehearsed the delete when `dry_run` is true. */
      200: {
        content: {
          "application/json": {
            /**
  ...
  getOrgAlertPolicyMigrationStatus: {
    ...
    responses: {
      /** @description The alert policy migration status of the organization. */
      200: {
        content: {
          "application/json": {
            /**
             * @description Current migration state. Null when the organization is not enrolled.
             * @default pending
             * @enum {string|null}
             */
            state: "pending" | "previewing" | "accepted" | "auto_finalized" | "rolled_back" | null;
            /**
             * @description ISO-8601 timestamp when migration finalized.
             * @default
             */
            finalized_at: string | null;
            /**
             * @description ISO-8601 auto-finalization deadline.
             * @default
             */
            deadline_at: string | null;
            /**
             * @description ISO-8601 end of the organization migration window.
             * @default
             */
            window_end_at: string | null;
            /**
             * @description ISO-8601 timestamp when an administrator paused the deadline.
             * @default
             */
            deadline_admin_paused_at: string | null;
            /**
             * @description Whether the alert policy layer evaluates for this organization. True for migrated organizations and for organizations that started on Rules & Policies.
             * @default false
             */
            alert_policies_enabled: boolean;
            /**
             * @description Whether legacy alert triage and the legacy security policy still evaluate for this organization.
             * @default true
             */
  ...
  translateOrgAlertPolicyMigrationTriage: {
    ...
    responses: {
      /** @description Translated requests, plus any entries that have no equivalent. */
      200: {
        content: {
          "application/json": {
            translations: Array<({
                /**
                 * @description Zero-based position of the source entry in the submitted `alertTriage` array.
                 * @default 0
                 */
                index: number;
                /**
                 * @description Which API replaces this triage entry.
                 * @default alert_resolution
                 * @enum {string}
                 */
                target: "alert_resolution" | "alert_policy_rule";
                /**
                 * @description HTTP method of the new request.
                 * @default POST
                 * @enum {string}
                 */
                method: "POST";
                /**
                 * @description Path of the new request. Policy rules target the default (Main) policy, which covers repositories without a policy label. Labeled policies do not inherit Main — replace `default` with that policy id if the rule should apply there.
                 * @default
                 */
                path: string;
                /**
                 * @description Request body to send. Resolutions: `{ reason, comment, vigil_selector }` (`reason` is `other`). Rules: `{ name, action, note, vigil_selector }` (`block` becomes `error`).
                 * @default null
                 */
            ...
            untranslatable: Array<({
                ...
                index: number;
                /**
                 * @description Why the entry was not translated.
                 * @default alert_key_not_translatable
                 * @enum {string}
                 */
                code: "inherit_not_translatable" | "alert_key_not_translatable" | "matches_all_alerts" | "filter_not_translatable" | "note_too_long";
                /**
                 * @description What to do instead. Safe to show to API clients.
                 * @default
                 */
                reason: string;
              })>;
          ...
          "application/json": {
            issueRules?: ({
              ...
              browserExtensionPermission?: {
                /**
                 * @description The action to take for browserExtensionPermission issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
              browserExtensionHostPermission?: {
                /**
                 * @description The action to take for browserExtensionHostPermission issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
              browserExtensionWildcardHostPermission?: {
                /**
                 * @description The action to take for browserExtensionWildcardHostPermission issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
              browserExtensionContentScript?: {
                /**
                 * @description The action to take for browserExtensionContentScript issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
              ...
              unresolvedYarnDependency?: {
                /**
                 * @description The action to take for unresolvedYarnDependency issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
              unresolvedPomReference?: {
                /**
                 * @description The action to take for unresolvedPomReference issues.
                 * @enum {string}
                 */
                action: "defer" | "error" | "warn" | "monitor" | "ignore";
              };
             ...
             * @enum {string|null}
             */
            issueRulesPolicyDefault?: "default" | "low" | "medium" | "high" | null;
            /** @default null */
            licensePolicy?: Record<string, unknown> | null;
            /**
             * @description The recently published package alert threshold for the repository label, in milliseconds
             * @default 0
             */
      ...
      200: {
        content: {
          "application/json": {
            ...
            /**
             * @description Enable Socket full application reachability analysis
             * @default false
             */
  ...
  postAPITokensRotate: {
    ...
    /** @description The API Token identifier to rotate. Provide uuid (recommended), id, token, or hash. May provide uuid+hash together for validation. */
    requestBody?: {
      content: {
        "application/json": {
          /**
          ...
          uuid?: string;
          /**
           * @description The API token ID to rotate
           * @default
           */
          id?: string;
          /** @default */
  ...
  postAPITokensRevoke: {
    ...
    /** @description The API token identifier to revoke. Provide uuid (recommended), id, token, or hash. May provide uuid+hash together for validation. */
    requestBody?: {
      content: {
        "application/json": {
          /**
          ...
          uuid?: string;
          /**
           * @description The API token ID to revoke
           * @default
           */
          id?: string;
          /** @default */
  ...
  getThreatFeedItems: {
    parameters: {
      query?: {
        ...
        ecosystem?: "github" | "cargo" | "clawhub" | "composer" | "chrome" | "firefox-extension" | "edge-extension" | "golang" | "huggingface" | "maven" | "npm" | "nuget" | "vscode" | "vscode-extension" | "pypi" | "gem" | "swift";
      };
    };
    responses: {

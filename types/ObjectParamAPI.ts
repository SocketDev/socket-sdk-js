...
export interface DefaultApiNpmPackageVersionIssuesGetRequest {
    /**
     * 
     * @type string
     * @memberof DefaultApinpmPackageVersionIssuesGet
     */
    _package: string
    /**
     * 
...
export interface DefaultApiNpmPackageVersionScoreGetRequest {
    /**
     * 
     * @type string
     * @memberof DefaultApinpmPackageVersionScoreGet
     */
    _package: string
    /**
     * 
...
export interface DefaultApiQuotaGetRequest {
}

export interface DefaultApiReportListGetRequest {
}

export interface DefaultApiReportUploadPutRequest {
}

export interface DefaultApiReportViewIdGetRequest {
    /**
     * 
     * @type string
     * @memberof DefaultApireportViewIdGet
     */
    id: string
}
...
export class ObjectDefaultApi {
     ...
     */
    public npmPackageVersionIssuesGet(param: DefaultApiNpmPackageVersionIssuesGetRequest, options?: Configuration): Promise<Array<SocketIssue>> {
        return this.api.npmPackageVersionIssuesGet(param._package, param.version,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public npmPackageVersionScoreGet(param: DefaultApiNpmPackageVersionScoreGetRequest, options?: Configuration): Promise<SocketPackageScore> {
        return this.api.npmPackageVersionScoreGet(param._package, param.version,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public quotaGet(param: DefaultApiQuotaGetRequest = {}, options?: Configuration): Promise<InlineResponse2001> {
        return this.api.quotaGet( options).toPromise();
    }

    /**
     * @param param the request object
     */
    public reportListGet(param: DefaultApiReportListGetRequest = {}, options?: Configuration): Promise<any> {
        return this.api.reportListGet( options).toPromise();
    }

    /**
     * @param param the request object
     */
    public reportUploadPut(param: DefaultApiReportUploadPutRequest = {}, options?: Configuration): Promise<InlineResponse200> {
        return this.api.reportUploadPut( options).toPromise();
    }

    /**
     * @param param the request object
     */
    public reportViewIdGet(param: DefaultApiReportViewIdGetRequest, options?: Configuration): Promise<SocketReport> {
        return this.api.reportViewIdGet(param.id,  options).toPromise();
    }

...
export class ObservableDefaultApi {
     ...
     * @param version 
     */
    public npmPackageVersionIssuesGet(_package: string, version: string, _options?: Configuration): Observable<Array<SocketIssue>> {
        const requestContextPromise = this.requestFactory.npmPackageVersionIssuesGet(_package, version, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.npmPackageVersionIssuesGet(rsp)));
            }));
    }
     ...
     * @param version 
     */
    public npmPackageVersionScoreGet(_package: string, version: string, _options?: Configuration): Observable<SocketPackageScore> {
        const requestContextPromise = this.requestFactory.npmPackageVersionScoreGet(_package, version, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.npmPackageVersionScoreGet(rsp)));
            }));
    }

    /**
     */
    public quotaGet(_options?: Configuration): Observable<InlineResponse2001> {
        const requestContextPromise = this.requestFactory.quotaGet(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.quotaGet(rsp)));
            }));
    }

    /**
     */
    public reportListGet(_options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.reportListGet(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.reportListGet(rsp)));
            }));
    }

    /**
     */
    public reportUploadPut(_options?: Configuration): Observable<InlineResponse200> {
        const requestContextPromise = this.requestFactory.reportUploadPut(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.reportUploadPut(rsp)));
            }));
    }
     ...
     * @param id 
     */
    public reportViewIdGet(id: string, _options?: Configuration): Observable<SocketReport> {
        const requestContextPromise = this.requestFactory.reportViewIdGet(id, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.reportViewIdGet(rsp)));
            }));
    }

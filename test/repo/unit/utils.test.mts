/**
 * @file Utility tests for URL, path, promise, query, and user-agent behavior.
 */
...
describe('Path Resolution', () => {
  ...
  describe('resolveAbsPaths', () => {
    it('should resolve array of relative paths to absolute', () => {
       ...
       */
      expect(normalizePath(result[0]!)).toMatch(/\/package\.json$/)
      expect(normalizePath(result[1]!)).toMatch(/\/src\/index\.ts$/)

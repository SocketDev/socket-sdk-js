 ...
 *   single distributed `bootstrap/fleet.mts`. Dep-0: node: builtins + the
...
export const SYNC_FLEET_SCRIPT = 'node bootstrap/fleet.mts'
...
export const FLEET_STATUS_SCRIPT = 'node bootstrap/fleet.mts --status'

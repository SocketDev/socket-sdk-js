...
// Split the literal so Vite's static pre-transform import scanner can't resolve
// it as a module path — this rule file is imported by a vitest test, and a
// single literal re-triggers the vite 8.1 lib-stable path-constant crash (#95).
// oxlint-disable-next-line no-useless-concat -- intentional split (see above).

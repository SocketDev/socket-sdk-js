...
0. An offline CI lane is not a violation, but the check prints `NOT VERIFIED`
and never the success line. An unread source that reports green is the failure mode this

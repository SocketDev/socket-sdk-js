...
2. The `enterprise-push-property-reminder` Stop-hook surfaces the bypass mechanism inline.
...
When the `enterprise-push-property-reminder` hook fires after a failed push, it surfaces:
